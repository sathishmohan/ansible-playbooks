...
#
# Usage ./vmlaunch.ps1 -vm_name xxx -ova_location xxxxx -vm_cpu xx -vm_memory xx -vm_storage xx -vm_datastore xxxxx
# Example : ./vmlaunch.ps1 -vm_name vm-1 -ova_location vm.ova -vm_cpu 2 -vm_memory 2 -vm_storage 20 -vm_datastore Esxi-1_Local2
# Author - sathishm
#
Param
(
